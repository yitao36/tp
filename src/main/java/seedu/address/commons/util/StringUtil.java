...
public class StringUtil {
    ...
    /**
     * Returns true if the {@code sentence} contains (ignoring case) the {@code substring}.
     * <br>examples:<pre>
     ...
     *       containsSubstringIgnoreCase("ABC DEF", "cd") == false // "cd" is broken up by a space in the sentence
     *       </pre>
     *
     * @param sentence  cannot be null
    ...
    public static boolean containsSubstringIgnoreCase(String sentence, String substring) {
        ...
        return Arrays.stream(wordsInPreppedSentence).anyMatch(s -> s.contains(preppedSubstring));
    }

    /**
     * Returns true if the {@code sentence} contains (ignoring case) the {@code substring}.
     * <br>examples:<pre>
     *       containsMultiWordSubstringIgnoreCase("ABc def", "abc") == true
     *       containsMultiWordSubstringIgnoreCase("ABc def", "DEF") == true
     *       containsMultiWordSubstringIgnoreCase("ABc def", "c d") == true
     *       containsMultiWordSubstringIgnoreCase("ABC DEF", "cd") == false
     *       </pre>
     *
     * @param sentence  cannot be null
     * @param substring cannot be null, cannot be empty
     */
    public static boolean containsMultiWordSubstringIgnoreCase(String sentence, String substring) {
        requireNonNull(sentence);
        requireNonNull(substring);
