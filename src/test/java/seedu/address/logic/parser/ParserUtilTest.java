...
public class ParserUtilTest {
    ...
    private static final String INVALID_ROLE = "!secretary";
    ...
    private static final String VALID_ROLE_2 = "camp leader 2";
    ...
    public void parseRole_validValueWithWhitespace_returnsTrimmedRole() throws Exception {
        ...
        Role expectedRole = new Role(VALID_ROLE_1);
        assertEquals(expectedRole, ParserUtil.parseRole(tagWithWhitespace));
    }
