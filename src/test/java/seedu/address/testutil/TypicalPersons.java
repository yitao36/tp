...
import static seedu.address.logic.commands.CommandTestUtil.VALID_PIN_AMY;
...
public class TypicalPersons {
    ...
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withEmergencyContact("Bernard Meier", "98762345")
    ...
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            ...
            .withPin(false).build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("94832224")
            .withEmail("werner@example.com").withAddress("michegan ave")
            .withPin(false).build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("94824927")
